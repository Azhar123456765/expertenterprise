@extends('layout.app') @section('title', 'Reciept Voucher') @section('content')
<style>
...
<div class="container">
    <h3 class="text-center my-2">Receipt Voucher</h3>
...
<div class="d-flex justify-content-center align-items-center"
    ...
    <a href="{{ Route('receipt_voucher.report', $rand) }}" class="edit pdf btn btn-secondary btn-md disabled"
