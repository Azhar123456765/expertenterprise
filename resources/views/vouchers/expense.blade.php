@extends('layout.app') @section('title', 'Expense Voucher') @section('content')
<style>
...
<div class="container">
    <h3 class="text-center my-2">Expense Voucher</h3>
...
<div class="d-flex justify-content-center align-items-center"
    ...
    <a href="{{ Route('expense_voucher.edit', $rand - 1) }}" class="btn px-3 p-1 btn-secondary btn-md  submit"id="previous_btn" data-bs-toggle="tooltip" 
        data-bs-placement="top" 
        title="Shortcut: Shift + B">
            Previous
    </a>
    <a href="{{ Route('expense_voucher.edit', $rand + 1) }}" class="btn px-3 p-1 btn-secondary btn-md  submit" id="next_btn" data-bs-toggle="tooltip" 
        data-bs-placement="top" 
    ...
    <a href="{{ Route('expense_voucher.report', $rand) }}" class="edit pdf btn btn-secondary btn-md" id="pdf">
        PDF
    </a>
