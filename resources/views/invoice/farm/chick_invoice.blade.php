@extends('layout.app') @section('title', 'Chick Invoice ') @section('content')
<style>
...
<div class="container">
    <h5 class="text-center my-2">Chick Invoice (Purchase+Sale)</h5>
...
">Customer</h6>
    ...
    ">Total</label>
                        ...
                        <input type="number" step="any" step="any" name="qty_total" id="qty_total" style="
                /* margin-left: 30%; */
                position: fixed;
                top: 95%;
                left: 26%;
...
" />
    ...
    <div class="d-flex justify-content-center align-items-center"
        ...
        <a href="{{ Route('new_invoice_chick') }}" class="edit add-more  btn px-3 p-1 btn-secondary btn-md disabled"
