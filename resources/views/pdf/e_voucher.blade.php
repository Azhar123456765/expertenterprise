@extends('pdf.farm.app') @section('pdf_content')
    @php
        $single_data = session()->get('s_expense_vouchers_pdf_data');
        $data = session()->get('expense_vouchers_pdf_data');
        // dd($data);
    ...
    <div class="ui segment cards">
        <div class="ui card customercard">
            ...
            <div class="content">
                <ul>
                    <li> <strong> Name: {{ $single_data->asset_accounts->account_name }} </strong> </li>
                </ul>
            </div>
        </div>
